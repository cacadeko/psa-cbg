...
class QualidadeSonoController
{
    private QualidadeSonoService $service;

    public function __construct(QualidadeSonoService $service)
    {
    ...
    public function atualizar($data)
    {
        ...
        if ($registro) {
            ...
            $registro->setQualidade($data['qualidade']);
