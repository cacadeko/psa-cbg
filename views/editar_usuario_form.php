...
<form method="POST" action="/pre-treino-rfc/controllers/routerEditarUsuario.php">
...
<a href="/pre-treino-rfc/views/lista_usuarios.php" class="btn btn-light w-100 mt-2">Cancelar</a>
</form></div></body></html>
