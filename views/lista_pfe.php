...
require_once '../controllers/PFEController.php';
use Controllers\PFEController;

$ctrl = new PFEController();
...
<div class="container mt-5 pt-5">
  <h3 class="text-center mb-4">Lista de PFE</h3>
  ...
  <!-- Filtro -->
  <form method="GET" action="lista_pfe.php" class="mb-4">
